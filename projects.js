...
const projects = [
	{
		...
		description: 'A molecular mass/mass percentage calculator in the form of a periodic table. It allows you to add and subtract elements by clicking on them, or by entering the formula.',
	...
	{
		title: 'Thoughtjar',
		description: 'A web app for organizing thoughts and ideas into categories. You can add new categories, assign them colors, and use them to filter thoughts. Utilizes service workers and the localStorage API to allow offline use.',
	...
	{
		title: 'Mirageo',
		description: 'A library for creating mock location data, optionally within a bounding box/polygon. <a href="https://github.com/nickroberts404/mirageo-server"><b>mirageo-server</b></a> spins up a local server that exposes the data via HTTP and provides a map interface for location visualization and bound manipulation.',
